...
Feature: Validating Preference menu functionality
 ...
 And Display Preferences menu page
  ...
  Scenario: Entering Negative Percentage Values
    Given the user is on the settings page
    When the user enters a negative percentage for Wholesale Price Percentage
    Then the Application displays a valid error message for the negative input
    
    When the user enters a negative percentage for Inventory Buffer Percentage
    Then the Application displays a valid error message for the negative input
