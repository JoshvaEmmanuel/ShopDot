...
Feature: Validating Brand Profile Menu functionality
 ...
 #And user clicks on Brand Profile menu from Settings
  ...
  @BP_Tc001
  Scenario: Test to verify error message displayed when user submit Brand Profile Page without entering Data
  ...
  @BP_Tc002
  Scenario: Test to verify display error message when user enter invalid contact mail
    And user enter invalid email on the Contact email field
    Then user should see the error message "Must be a valid email."

  @BP_Tc003
  Scenario: Test to verify display error message when user enter invalid Brand Website
    And user enter invalid Brand Website
    Then user should see the error message "Please enter correct website url!"

  @BP_Tc004
  Scenario: Test to verify Successful message is displayed on Brand Profile page
